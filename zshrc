...
export PATH="$PATH:/opt/idea-IU-231.8109.1754/bin"
...
alias v="$HOME/nvim-linux64/bin/nvim"
alias idea="/opt/idea-IU-231.8109.175/bin/idea.sh"
...
__conda_setup="$('/home/nick/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/nick/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/nick/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/nick/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
